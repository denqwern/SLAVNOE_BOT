...
from routers.Keyboard import key_selsovet, key_get_start, key_raiispolk, key_social_objects, key_cerkov, key_tourists, \
    key_lake, key_get_raspisaniee, key_get_raspisanie, key_eventt, key_ysha, key_ysh, vlast, key_histt, key_ek, \
...
async def send_naselennyi_punkt(message: types.Message):
    if message.from_user.id == int(2039046861):
        await message.answer(text="Выполнен вход в панель администатора коммуникационной платформы: ", reply_markup=admin_functions())
    else:
...
home = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="︎✔︎ Авхуты", url='https://telegra.ph/Avhuty-Slapovskij-selskij-sovet-06-30')],
                                            [InlineKeyboardButton(text=f"Антоново", callback_data="Antonovo")],
                                            [InlineKeyboardButton(text='Глинники', callback_data="Glinniki")],
                                            [InlineKeyboardButton(text='Горожоны', callback_data="Gorozhony")],
                                            [InlineKeyboardButton(text='Губарево', callback_data='Gubarevo')],
                                            ...
                                            [InlineKeyboardButton(text='Заречье', callback_data='Zareche')],
                                            [InlineKeyboardButton(text='Зяблица', callback_data='Zjablica')],
                                            [InlineKeyboardButton(text='Ильяни', callback_data='Iljani')],
                                            [InlineKeyboardButton(text='Каменица', callback_data='Kamenica')],
                                            [InlineKeyboardButton(text='Каменка', callback_data='Kamenka')],
                                            [InlineKeyboardButton(text='Курчи', callback_data='Kurchi')],
                                            [InlineKeyboardButton(text='Ламинщина', callback_data='Laminshhina')],
                                            [InlineKeyboardButton(text='Майдан', callback_data='Majdan')],
                                            [InlineKeyboardButton(text='Молявка', callback_data='Moljavka')],
                                            [InlineKeyboardButton(text='Нарцизово', callback_data='Narcizovo')],
                                            [InlineKeyboardButton(text='Новая Яблонка', callback_data='NovajaJablonka')],
                                            [InlineKeyboardButton(text='Славное', callback_data='Slavnoe')],
                                            [InlineKeyboardButton(text='Словени', callback_data='Sloveni')],
                                            [InlineKeyboardButton(text='Тростянка', callback_data='Trostjanka')],
                                            [InlineKeyboardButton(text='Химец', callback_data='Himec')],
                                            [InlineKeyboardButton(text='Яблонка', callback_data='Jablonka')]])
...
async def send_selsovet(message: types.Message):
    ...
    photo_2 = '/Users/dzianis/PycharmProjects/SLV_BOT/routers/pic/О сельсовете/slavnoe_cc.JPG'
    ...
    await message.answer(text=f"{text} \\- административная единица на территории Толочинского района"
                              ...
                              f"\n\n{text2} \\- Славновский сельский исполнительный комитет\\. Юридический адрес \\- агрогородок Славное, ул\\.Советская, д\\. 25\\.", reply_markup=key_selsovet(), parse_mode=ParseMode.MARKDOWN_V2)
...
async def send_contact_info(message: types.Message):
    await message.answer(text="\n\n*ПРЕДСЕДАТЕЛЬ* \\- 8\\(02136\\)29845"
                              ...
                              "\n\n❗Прямая телефонная линия с гражданами и представителями юридических лиц осуществляется председателем Славновского сельского исполнительного комитета каждую 2\\-ю субботу месяца с 09\\.00ч\\. по 12\\.00ч\\. по телефону \\+375297100990", parse_mode=ParseMode.MARKDOWN_V2)


raiisp_one = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="Приемная", url='https://telegra.ph/Priemnaya-rajispolkoma-08-18')],
                                                [InlineKeyboardButton(text="Структура", callback_data="struct")],
                                               [InlineKeyboardButton(text="Одно окно", url='https://telegra.ph/Obshchaya-informaciya-o-sluzhbe-odno-okno-08-18')],
...
async def Slavn(callback: CallbackQuery):
    path_one = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Функции и задачи райисполкома.doc'
    pathe_two = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Структура райисполкома.doc'
...
sud = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="По уголовным/административным делам", callback_data='ygol')],
...
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/SudTolochin.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
...
async def Slavn(callback: CallbackQuery):
    path_one = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Взыскание алиментов в порядке искового производства(2).doc'
    pathe_two = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Взыскание алиментов в порядке приказного производства(4).doc'
    pathe_three = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Взыскание заработной платы.doc'
    pathe_four = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Жалоба на действия судебного исполнителя(1).docx'
    pathe_five = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Заявление о возбуждении уголовного дела частного обвинения.docx'
    pathe_six = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О взыскании долга.doc'
    pathe_seven = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О восстановлении на работе и оплате за время вынужденного прогула(1).docx'
    pathe_nine = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О выдаче дубликата исполнительного листа.doc'
    pathe_ten = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О предоставлении свидания с обвиняемым.docx'
    pathe_nine_1='/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О признании гражданина недееспособным(3).docx'
    pathe_nine_2='/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/О признании утратившим право пользования жилым помещением(4).docx'
    pathe_nine_3='/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Об индексации взысканной суммы.doc'
    pathe_nine_4='/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Об установлении факта получения заработной платы за конкретный период в определенном размере(2).docx'
    pathe_nine_5='/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/Расторжение брака(2).docx'
...
async def Slavn(callback: CallbackQuery):
    path_1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление.docx'
    path_2 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление кредитора  о признании должника банкротом (образец).doc'
    path_3 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление на возврат госпошлины (2).doc'
    path_4 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление на составление мотивировочной части.docx'
    path_5 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о возбуждении приказного производства (3).doc'
    path_6 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о выдаче дубликата судебного приказа.docx'
    path_7 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о завершении примирительной процедуры.docx'
    path_8 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о замене стороны ее правопреемником.docx'
    path_9 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о предоставлении рассрочки исполнения судебного постановления (1).doc'
    path_10 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о признании должника банкротом (образец).doc'
    path_11 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление о признании должника несостоятельным  (образец).doc'
    path_12 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Заявление об отказе от заявленных требований (приказное производство).docx'
    path_13 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/заявление об отказе от иска.docx'
    path_14 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Исковое заявление о взыскании долга по договору поставки.docx'
    path_15 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Отзыв на заявление о возбуждении приказного производства.docx'
    path_16 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Претензия  о взыскании задолженности за поставленную продукцию (1).doc'
    path_17 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Расторжение брака(2).docx'
    path_18 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Ходатайство о восстановлении пропущенного срока на подачу апкл_жалобы.docx'
    path_19 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Ходатайство о назначении примирителя (1).doc'
    path_20 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Ходатайство о привлечении третьего лица.docx'
    path_21 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/econom/Ходатайство о рассмотрении дела в порядке искового производства (3).doc'
...
async def Slavn(callback: CallbackQuery):
    path = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/intellect/Исковое заявление - 2.docx'
    path_1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/intellect/Исковое заявление - 3.docx'
    path_2 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/intellect/Исковое заявление  - 1(3).docx'
    path_3 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/intellect/О взыскании вознаграждения, пени и процентов за пользование чужими денежными средствами(2).docx'
...
@router.message(F.text == "Церковь")
async def send_cerkov(message: types.Message):
    photo = '/Users/user/Downloads/Новая папка (2)/с.JPG'
    await message.answer_photo(photo=types.FSInputFile(path=photo))
    await message.answer(text='*ХРАМ "СОБОР БЕЛОРУССКИХ СВЯТЫХ" ВИТЕБСКОЙ ЕПАРХИИ БЕЛОРУССКОЙ ПРАВОСЛАВНОЙ ЦЕРКВИ:*'
                              '\n\nАдрес: агрогородок Славное\\, улица Советская\\, 1'
                              '\n\n_В Славном до революции функционировал православный храм\\, построенный в период с 1909 по 1915 года\\. Алтарь храма отличался богатым убранством\\. В период Великой Отечественной войны здание было сожжено\\.'
                              ' 6 февраля 1997 года зарегистрирован приход\\. В 1998 году возведена деревянная часовня\\. В 1999 году начато строительство храма из красного кирпича\\.'
                              ' 29 мая 2010 года настоятелем прихода иереем Александром Денисевичем состоялось первое богослужение\\. Храм возведен при непосредственной помощи неравнодушных земляков\\, руководства ОАО "СЛАВНОЕ"\\._',
                         parse_mode=ParseMode.MARKDOWN_V2, reply_markup=key_cerkov())

    photo2 = '/Users/user/Downloads/Новая папка (2)/с2.JPG'
    await message.answer_photo(photo=types.FSInputFile(path=photo2))

@router.message(F.text == "Населенные пункты")
async def send_naselennyi_punkt(message: types.Message):
    await message.answer(text="Выберите деревню: ", reply_markup=village)


@router.message(F.text == "Великие праздники")
async def send_velikie_prazdnike(message: types.Message):
    named_tuple = time.localtime()  # получить struct_time
    ...
    path = '/Users/user/Downloads/Новая папка (2)/slavnoe_1.db'
    connection = sqlite3.connect(path)
    n = str()

    for num in time_string_2:
        n += num

    cur = connection.cursor()
    cur.execute(f'SELECT data, prazd  FROM prazdn')
    dff = cur.fetchall()
    a = ""
    for sum in dff:
        a += (f"Дата: {sum[0]}\n"
    ...
    await message.answer(text=f'{time_string_2}'
                              f'\n\nДвунадесятые и великие праздники 2024 года:'
                              f'\n\n{a}')
    cur.close()
    connection.close()
...
async def send_gallery(message: types.Message):
    photo_1 = '/Users/user/Downloads/Новая папка (2)/x.JPG'
    photo_3 = '/Users/user/Downloads/Новая папка (2)/x2.JPG'
    photo_4 = '/Users/user/Downloads/Новая папка (2)/x3.JPG'
    photo_5 = '/Users/user/Downloads/Новая папка (2)/x4.JPG'
    photo_6 = '/Users/user/Downloads/Новая папка (2)/x5.JPG'
    photo_7 = '/Users/user/Downloads/Новая папка (2)/x6.JPG'
    photo_8 = '/Users/user/Downloads/Новая папка (2)/x7.JPG'

    await message.answer_photo(photo=types.FSInputFile(path=photo_1))
    ...
    await message.answer_photo(photo=types.FSInputFile(path=photo_5))
    await message.answer_photo(photo=types.FSInputFile(path=photo_6))
    await message.answer_photo(photo=types.FSInputFile(path=photo_7))
    await message.answer_photo(photo=types.FSInputFile(path=photo_8))

    await message.answer(text="Деня, НУЖНО СДЕЛАТЬ АЛЬБОМ! И УДАЛИТЬ МЕНЯ!")



@router.message(F.text == "Туризм и отдых")
async def send_tourists_and_otdykh(message: types.Message):
    await message.answer(text="Туризм и отдых", reply_markup=key_tourists())

@router.message(F.text == "Озера")
async def send_lake(message: types.Message):
    photo1 = '/Users/user/Downloads/Новая папка (2)/oz.JPG'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    text = '[Зяблицкие озера](https://yandex.by/maps/?ll=29.447630%2C54.249864&mode=whatshere&whatshere%5Bpoint%5D=29.441139%2C54.253825&whatshere%5Bzoom%5D=15.33&z=15)'
    await message.answer(
        text=f"📍{text}\\, расположены среди заболоченного лесного массива на стыке границ Витебской\\, Могилёвской и Минской областей\\. \n\nСогласно военно\\-топографической карты Российской Империи от 1850 года озера имеют следующие названия\\:"
             "\n\n● Новинка \\(вблизи д\\.Зяблица\\)\\;"
             "\n● Космачевка \\(среднее\\)\\;"
             "\n● Бездонное\\;"
             "\n● Дубовое\\.",
        parse_mode=ParseMode.MARKDOWN_V2, reply_markup=key_lake())

    photo_2 = '/Users/user/Downloads/Новая папка (2)/oz1.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo_2))

    await message.answer(text="Отчет ревизии Глининской лесной дачи Толочинского лесничества от 1923 года."
                              "\n\nОбщая площадь лесной дачи составляла 1803 десятины: «Дача лежит в Кручанской волости. Собственно лесная площадь составляла всего 769 десятин. Дача обслуживала население примерно в 15000 человек. "
                              "Основными потребителями лесной продукции являлись местечки Славяны, Кручи, деревни Глинники,  Горожаны, Явхуты, Курчи, Зябрица, Куликовка, Залазье, Губарево, Поречье, Погребище и другие, всего 2000 дворов. Лесистость той части Могилёвского уезда, где расположена Глининская дача, составляла 23,5 %. Промышленных предприятий, а равно кустарных промыслов, в этом районе не было. Оптовым покупателем дров и брёвен был железнодорожный комитет Балтийской железной дороги»."
                              "\n\nПлощадь, покрытая лесом, составляла 498 десятин, редины — 32 десятины, непокрытых лесом было 239 десятин, неудобной земли — 1024 десятины. Глининская дача лежит на заболоченной низине, среди которой возвышаются островки, покрытые лесом."
                         )

    photo_3 = '/Users/user/Downloads/Новая папка (2)/oz2.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo_3))

    await message.answer(text="В 1923 году на всю территорию дачи имелось всего 19 квартальных столбов, ныне в лесничестве их более 500, что в 26 раз больше. Кварталом считался квартал размером 2 версты на 1 версту (0,5 км на 0,5 км). Охранялась дача тремя лесниками, норма обхода была 500 дес. и производилась одним объездчиком."
                              "\n\nЛесные озера в рамках ревизии отмечены как малорыбные и не представляющие интереса для рыбной ловли."
                              "\n\n26 мая 1925 года по итогам ревизии Глининской лесной дачи Дудаковичского лесничества Оршанского округа состоялось совещание, которое вёл зам.начальника управления лесами Наркомзема Хрущёв. По итогам совещания размер главного ежегодного лесопользования был назначен в 5 десятин в хвойном хозяйстве и 0,5 десятины в лиственном. На каждой десятине вырубки надлежало оставлять до 40 деревьев-семенников сосны.")

    photo_4 = '/Users/user/Downloads/Новая папка (2)/oz3.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo_4))

    await message.answer(text="В 1911 году учеными проведены исследования, составлен проект осушения болотных массивов Глининской лесной дачи. На начало 19 века мелиорация на нашей территории осуществлялась способом рытья каналов, а спрямленное русло реки Еленка, вытекающей из озера Космачевское (Среднее), есть свидетельство дореволюционных попыток осушения торфяников близ озер - ценный памятник истории и культуры.")

@router.message(F.text == "Памятные места")
async def send_tourists_and_otdykh(message: types.Message):
    await message.answer(text="Описание памятных мест")
...
@router.message(F.text == "Автобусы")
async def send_bus(message: types.Message):
    await message.answer(text="Выберите остановочный пункт:", reply_markup=key_bus())
...
async def village(message: types.Message):
    await message.answer(text="Толочин впервые упоминается в 1433 г\\. как город Великого княжества Литовского\\, который принадлежал князьям Друцким\\. Родоначальник князей Толочинских являтся князь Михаил Толочинский\\, сын князя Ивана Семеновича Друцкого\\-Путяты \\(1380\\-1440\\)\\. Все князья Друцкие использовали единый герб «Друцк»\\."
                              ...
                              "\n\n*Герб* города Толочина и Толочинского района создан на основе частновладельческого герба князей Толочинских\\-Друцких\\, учрежден Геральдическим советом при Президенте Республики Беларусь в 2002 году\\, является символом исторической преемственности поколений людей\\, населяющих земли Толочинского района более 1000 лет\\.", parse_mode=ParseMode.MARKDOWN_V2)
    photo1 = '/Users/user/Downloads/Новая папка (2)/gb1.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="*Флаг* представляет собой прямоугольное полотнище красного цвета с соотношением сторон 1\\:2\\, в центре лицевой стороны которого размещено изображение герба города Толочина и Толочинского района\\. Утвержден Указом Президента Республики Беларусь от 28 февраля 2011 года № 86\\.", parse_mode=ParseMode.MARKDOWN_V2)
...
raiisp = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="︎История", url='https://telegra.ph/Istoriya-rajona-08-16')],
                                               [InlineKeyboardButton(text="Геральдика", url='https://telegra.ph/Geraldika-rajona-08-16')],
                                               [InlineKeyboardButton(text="Наследие", url='https://telegra.ph/Istoriko-kulturnoe-nasledie-08-17')]])


@router.message(F.text == "География и население")
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/tolochin-s-vysoty_5.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="Толочинский район был образован 17 июля 1924 года.\n\nГраничит на востоке с Оршанским, на севере с Чашникским и Сенненским районами Витебской, на юге со Шкловским и Круглянским районами Могилевской области, на западе – с Крупским районом Минской области.\n\nПо территории района проходят автотрасса Брест-Минск-граница Российской Федерации, железная дорога того же направления.\n\nВ составе района 7 сельских Советов. Населенных пунктов 260.\n\nНаселение Толочинского района составляет 21 800 человека (на 1 января 2024 года). В сельской местности проживает 8 407 человек. Городское население г.Толочин - 9 666 человека, г.п.Коханово - 3 727 человека.", reply_markup=raiisp)

zags = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="График работы", url='https://telegra.ph/Rezhim-raboty-ZAGS-08-18')],
                                               [InlineKeyboardButton(text="Грифик приема", url='https://telegra.ph/Grafik-priyoma-zainteresovannyh-lic-po-osushchestvleniyu-administrativnyh-procedur-08-18')],
                                               [InlineKeyboardButton(text="Формы заявлений", callback_data='avtr')]])


@router.message(F.text == "Отдел ЗАГС")
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/загс/iаа.jpeg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    ...
    async def Slavn(callback: CallbackQuery):
        path_one = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/загс/Dopolnitelnye-platnye-uslugi,-okazyvaemye-otdelom-zags-.doc'
        pathe_two = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/загс/itogi-raboti-za-2022-1.docx'
        pathe_three = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/загс/Oplata-2024.doc'
        pathe_four = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/загс/Porjadok-obzhalovanija-administrativnyx-reshenij-1.doc'
...
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/ровд/XXXL.jpeg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="Адрес: 211092 ул. Ленина, 35, г.Толочин, Витебская область"
                              ...
                              "\n\nРежим работы РОВД: с 09:00 до 18:00 (обед с 13:00 до 14:00), суббота и воскресенье – выходной. Оперативно-дежурная служба – круглосуточно (тел. 102, 2-11-06, +375293140002, +375295970213).", reply_markup=key_slb())


@router.message(F.text == "РОЧС")
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/ровд/kak-za-kamennoy-stenoy.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="Толочинский районный отдел по чрезвычайным ситуациям"
                              ...
                              "\n\nВ выходные и праздничные дни приём проводится ответственным лицом по отделу с 9-00 до 13-00.", reply_markup=key_slb())


@router.message(F.text == "ОПИ")
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/ровд/1032532709_4-0-1915-1080_2072x0_60_0_0_bdad083478d0256f0968c33fca54ae64.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="Отдел принудительного исполнения Толочинского района управления принудительного исполнения главного управления юстиции Витебского областного исполнительного комитета"
                              ...
                              "\n\nБанковские реквизиты: р/с BY68AKBB36429030098962200000, код банка AKBBBY2X, Г.МИНСК, ОАО АСБ БЕЛАРУСБАНК, УНП 300002505", reply_markup=key_slb())
...
prokur = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="Общая информация", url='https://telegra.ph/Obshchaya-informaciya-08-18-2')],
...
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/ровд/3-plakat-3x6-100-let.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
    await message.answer(text="Прокуратура Толочинского района входит в единую и централизованную систему органов прокуратуры Республики Беларусь."
...
async def send_raiispolcom(message: types.Message):
    photo1 = '/Users/user/Desktop/СЛАВНОЕ/СЛАВНОЕ БОТ/routers/pic/raiispolk/ровд/1013397345_0-0-2720-1530_2072x0_60_0_0_002c7d57178c0b27fb86dd97c5e8095d.jpg'
    await message.answer_photo(photo=types.FSInputFile(path=photo1))
...
async def send_raiispolcom(message: types.Message):
    ...
    await message.answer(text="НОТАРИАЛЬНАЯ КОНТОРА ТОЛОЧИНСКОГО РАЙОНА"
                              ...
                              "\n\nНа прием к нотариусу в агрогородках можно записаться в нотариальной конторе Толочинского района по телефонам: 5-10-31; 5-17-11; Viber: +375296848137. На сайте Белорусской нотариальной палаты имеется возможность подачи заявки на выезд нотариуса в агрогородки электронным способом.", reply_markup=key_slb())
